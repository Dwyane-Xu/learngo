...
var file_helloworld_proto_rawDesc = []byte{
	...
	0x73, 0x61, 0x67, 0x65, 0x32, 0x42, 0x0a, 0x0e, 0x47, 0x72, 0x65, 0x65, 0x74, 0x65, 0x72, 0x53,
	...
	0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x10, 0x2e, 0x6d, 0x61, 0x69, 0x6e, 0x2e, 0x48, 0x65,
	0x6c, 0x6c, 0x6f, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
...
var file_helloworld_proto_depIdxs = []int32{
	0, // 0: main.GreeterService.SayHello:input_type -> main.HelloRequest
	1, // 1: main.GreeterService.SayHello:output_type -> main.HelloReply
...
func (c *greeterServiceClient) SayHello(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloReply, error) {
	out := new(HelloReply)
	err := c.cc.Invoke(ctx, "/main.GreeterService/SayHello", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _GreeterService_SayHello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/main.GreeterService/SayHello",
	}
...
var _GreeterService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "main.GreeterService",
